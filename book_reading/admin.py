...
from .models import Book, Chapter, ReadingProgress, Course, Exam, Improve, ReadingPlan
...
class ReadingPlanAdmin(admin.ModelAdmin):
    list_display = ("course", "book", "start_around", "note")
    list_filter = ("course", "start_around")
